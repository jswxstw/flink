...
import org.apache.flink.formats.json.custom.canal.CanalJsonDecodingFormat.ReadableMetadata;
...
public final class CanalJsonDeserializationSchema implements DeserializationSchema<RowData> {
    ...
    private static final String OP_INIT = "INITINSERT";
    ...
    public void deserialize(@Nullable byte[] message, Collector<RowData> out) throws IOException {
        ...
        try {
            ...
            if (OP_INIT.equals(type) || OP_INSERT.equals(type)) {
